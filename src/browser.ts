...
function initEditableTable(options: initOptions) {
...
function fetchTableData(selector: string): Record<string, string>[] {
...
function arrayToTable(options: TableOptions): HTMLTableElement {
...
function addRowToTable(selector: string, cellValues: string[]) {
  // Get the table
  let table = document.querySelector(selector) as HTMLTableElement;
...
function deleteRowFromTable(selector: string, rowIndex: number) {
  // Get the table
  let table = document.querySelector(selector) as HTMLTableElement;
