"use strict";
function initEditableTable(options) {
...
function fetchTableData(selector) {
...
function getCellValue(selector, rowIndex, cellIndex) {
    let table = document.querySelector(selector);
    if (table &&
        table.rows &&
        table.rows[rowIndex] &&
...
function updateTableCell(selector, rowIndex, cellIndex, newText) {
    let table = document.querySelector(selector);
    if (table &&
        table.rows &&
        table.rows[rowIndex] &&
...
function updateLastRowCell(selector, cellIndex, newText) {
    let table = document.querySelector(selector);
...
function addRowToTable(selector, cellValues) {
    let table = document.querySelector(selector);
...
function updateRowInTable(selector, rowIndex, newCellValues) {
    let table = document.querySelector(selector);
...
function deleteRowFromTable(selector, rowIndex) {
    let table = document.querySelector(selector);
    if (table && table.rows && table.rows[rowIndex]) {
...
function forEachRowInTable(selector, callback) {
    let table = document.querySelector(selector);
    if (table && table.rows) {
